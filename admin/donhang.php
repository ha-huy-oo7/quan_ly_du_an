...
{
    $sql_query1="DELETE FROM tbl_cart WHERE tbl_cart.idbill=".$_GET['delete_id'];
    $sql_query2="DELETE FROM tbl_bill WHERE tbl_bill.id=".$_GET['delete_id'];
    mysqli_query($links, $sql_query1);
    mysqli_query($links, $sql_query2);
...
function edt_id(id)
{
    ...
    {
        window.location.href='suadonhang.php?edit_id='+id;
    }
}
function delete_id(id)
{
    ...
    {
        window.location.href='donhang.php?delete_id='+id;
    }
}
</script>
</head>
...
<tr>
    <th class="masp">Mã KH</th>
    <th class="tensp">Tên KH</th>
    <th class="tensp">Tên sản phẩm</th>
    <th class="tensp">Địa chỉ</th>
    <th class="sl">Số điện thoại</th>
    <th class="mancc">Đơn giá</th>
    <th class="sl">Số lượng</th>
    <th class="sl">Thành tiền</th>
    <th class="masp">Tác vụ</th>
</tr>

<?php
    
    $sql_select="SELECT tbl_bill.id,name,tensp,address,tel,dongia,soluong,thanhtien FROM tbl_bill,tbl_cart WHERE tbl_bill.id=tbl_cart.idbill ORDER BY id";
