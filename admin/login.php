...
<body class="bg-gradient-primary">
    <form action="sqlphp/xuly.php" method="POST">
    <div class="container">
                                    ...
                                    <form class="user">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customCheck">Nhớ mật khẩu
                                                    </label>
                                            </div>
                                        </div>                                     
                                        ...
                                        <a href="index.php" class="btn btn-google btn-user btn-block">
                                            <i class="fab fa-google fa-fw"></i> Đăng nhâp với Google
                                        </a>
                                        <a href="index.php" class="btn btn-facebook btn-user btn-block">
                                            <i class="fab fa-facebook-f fa-fw"></i> Đăng nhâp với Facebook
                                        </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
