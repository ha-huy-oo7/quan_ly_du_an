<?php
    ...
    {
        $sql_query="DELETE FROM mota WHERE masp=".$_GET['delete_id'];
...
<head>
    ...
    <title>Thông tin chi tiết mô tả sản phẩm</title>
...
function edt_id(id)
{
    ...
    {
        window.location.href='suamota.php?edit_id='+id;
    }
}
function delete_id(id)
{
    ...
    {
        window.location.href='mota.php?delete_id='+id;
    }
}
</script>
</head>
   ...
   <table class="table table-hover">
    <thead>
      <tr>
        ...
        <th class="tenncc">Tên nhà cung cấp</th>
        <th class="tacgia">Tác giả</th>
        <th class="nxb">Nhà xuât bản</th>
        <th class="namxb">Năm xuất bản</th>
        <th class="sotrang">Số trang</th>
        <th style="line-height:50px;">Tác vụ</th>
      </tr>
    </thead>
    <tbody>
      <?php
    
    $sql_query="SELECT * FROM mota";
    ...
    {   
        while($row=mysqli_fetch_row($result_set))
        {
            ?>
        <tr>
        <td class="mahang"><?php echo $row[1] ?>
            
        </td>
        <td class="tenncc"><?php echo $row[2] ?>
            
        </td>
        <td class="tacgia"><?php echo $row[3] ?>
            
        </td>
        <td class="nxb"><?php echo $row[4] ?>
            
        </td>
        <td class="namxb"><?php echo $row[5] ?></td>
          <td class="sotrang"><?php echo $row[9] ?></td>
          <td>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Chọn "Logout" bên dưới nếu bạn đã sẵn sàng để kết thúc phiên hiện tại của mình.</div>
