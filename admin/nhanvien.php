<?php
    ...
    {
        $sql_query="DELETE FROM nhanvien WHERE manv=".$_GET['delete_id'];
...
function edt_id(id)
{
    ...
    {
        window.location.href='suanhanvien.php?edit_id='+id;
    }
}
function delete_id(id)
{
    ...
    {
        window.location.href='nhanvien.php?delete_id='+id;
    }
}
</script>
</head>
...
<div class="container-fluid" style="font-size: 12px;">         
   <table class="table table-hover">
    <thead>
      <tr>
        <th class="manv">Mã Nhân Viên</th>
        <th class="tennv">Tên Nhân Viên</th>
        <th class="sex">Giới Tính</th>
        <th class="ngaysinh">Năm sinh</th>
    ...
    {   
        while($row=mysqli_fetch_row($result_set))
        {
            ?>
        <tr>
        <td class="manv"><?php echo $row[0] ?>
        </td>
        <td class="tennv"><?php echo $row[1] ?>
            
        </td>
        <td class="sex"><?php echo $row[2] ?>
            
        </td>
        <td class="ngaysinh"><?php echo $row[3] ?>
            
        </td>
        <td class="sdt"><?php echo $row[4] ?>
            
        </td>
        <td class="diachi"><?php echo $row[5] ?>
