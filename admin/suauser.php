...
{
    $sql_query= mysqli_query($links,"SELECT * FROM admin WHERE admin.id =".$_GET['edit_id']);
    $sql_show = mysqli_fetch_array($sql_query);
}
 ?>
<!DOCTYPE html>
<html>
...
<div id="content-wrapper" class="d-flex flex-column">
    <form method="POST" action="sqlphp/updateUSERS.php">
    <div id="content">
        <div class="thanhhome">
            <a href="admin.html"><label><i class="fas fa-home"></i>Trang chủ</label></a>
            <i class="fas fa-greater-than"></i><a style="margin:0px 10px" href="buttons.html"><label>Quản Lý Tài Khoản</label></a>
            <i class="fas fa-greater-than"></i><a style="margin:0px 10px" href="themsanpham.html"><label>Sửa User</label></a>
        </div>

    <div class="taikhoanuser" style="margin: 10px 10px;">
    ...
    <tbody>
        <tr>
        <td>id: <input type="text" class="themuser form-control bg-light border-0 small" placeholder="Điền id user"aria-label="Search" aria-describedby="basic-addon2" name="id" value="<?php echo $sql_show['id'] ?>"></td>
      </tr>
      <tr>
        <td>Tên tài khoản: <input type="text" class="themuser form-control bg-light border-0 small" placeholder="Điền tên tài khoản"aria-label="Search" aria-describedby="basic-addon2" name="suauser" value="<?php echo $sql_show['username'] ?>"></td>
      </tr>
      <tr>
        <td>Mật Khẩu: <input type="text" class="themuser form-control bg-light border-0 small " placeholder="Điền mật khẩu"aria-label="Search" aria-describedby="basic-addon2" name="mkuser" value="<?php echo $sql_show['password'] ?>"></td>
      </tr>
      <tr>
        <td>Nhập lại mật khẩu:<input type="text" class="themuser form-control bg-light border-0 small " placeholder="Điền lại mật khẩu"aria-label="Search" aria-describedby="basic-addon2" name="mkuser" value="<?php echo $sql_show['password'] ?>"></td>
      </tr>
      <tr>
        <td>
