...
<div id="content-wrapper" class="d-flex flex-column">
    <form action="sqlphp/updatedh.php" method="POST">
    <div id="content">
        <div class="thanhhome">
            ...
            <i class="fas fa-greater-than"></i><a style="margin:0px 10px" href="themsanpham.html"><label>Thêm khách hàng</label></a>
        </div>
    ...
    <thead>
      <tr>
        <th>Thêm khách hàng</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>Mã khách hàng: <input type="text" class="form-control bg-light border-0 small" "aria-label="Search" aria-describedby="basic-addon2" name="id"></td>
      </tr>
      <tr>
        <td>Tên khách hàng: <input type="text" class=" form-control bg-light border-0 small " aria-label="Search" aria-describedby="basic-addon2" name="name"></td>
      </tr>
      <tr>
        <td>Địa chỉ: <input type="text" class=" form-control bg-light border-0 small " aria-label="Search" aria-describedby="basic-addon2" name="address" ></td>
      </tr>

      <tr>
        <td>Số điện thoại: <input type="text" class=" form-control bg-light border-0 small " aria-label="Search" aria-describedby="basic-addon2" name="tel" ></td>
      </tr>
      <tr>
        <td>Email: <input type="text" class=" form-control bg-light border-0 small " aria-label="Search" aria-describedby="basic-addon2" name="email"></td>
      </tr>
      <tr>
        <td>Tổng Tiền: <input type="text" class="t form-control bg-light border-0 small " aria-label="Search" aria-describedby="basic-addon2" name="total" ></td>
      </tr>
        </tr>
        <td>
