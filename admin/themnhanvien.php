...
<!------ket thuc danh muc nhan vien ----->
            <li class="nav-item">
                ...
                <div id="collapsnhanvien" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Quản lý Thống kê báo cáo</h6>
                        <a class="collapse-item" href="#">Thông tin báo cáo</a>
                        <a class="collapse-item" href="#">Thêm Báo cáo</a>
                        <a class="collapse-item" href="#">Sửa báo cáo</a>
                        <div class="collapse-divider"></div>
                    </div>
                </div>
            </li>
...
<div id="content-wrapper" class="d-flex flex-column">
    <div id="content">
        <div class="thanhhome">
            ...
            <i class="fas fa-greater-than"></i><a style="margin:0px 10px" href="themsanpham.html"><label>Thêm nhân viên</label></a>
        </div>
    ...
    <form action="sqlphp/insertNV.php" method="POST">
    <tbody>
      <tr>
        <td>Mã nhân viên: <input type="text" class="manv form-control bg-light border-0 small" placeholder="Điền mã nhân viên"aria-label="Search" aria-describedby="basic-addon2" name="manv"></td>
      </tr>
      <tr>
        <td>Tên nhân viên: <input type="text" class="tennv form-control bg-light border-0 small " placeholder="Điền Tên Nhân Viên"aria-label="Search" aria-describedby="basic-addon2" name="tennv"></td>
      </tr>
      <tr>
        <td>Giới tính: <input type="text" class="sex form-control bg-light border-0 small " placeholder="Điền vào đây giới tính"aria-label="Search" aria-describedby="basic-addon2" name="gioitinh"></td>
      </tr>
      <tr>
        <td>Ngày sinh: <input type="text" class="ngaysinh form-control bg-light border-0 small " placeholder="Điền vào đây ngày sinh"aria-label="Search" aria-describedby="basic-addon2" name="ngaysinh"></td>
      </tr>
      <tr>
        <td>Số điện thoại: <input type="text" class="sdt form-control bg-light border-0 small " placeholder="Điền vào số diện thoại"aria-label="Search" aria-describedby="basic-addon2" name="sdt"></td>
      </tr>
      <tr>
        <td>Địa chỉ: <input type="text" class="diachi form-control bg-light border-0 small " placeholder="Điền vào địa chỉ"aria-label="Search" aria-describedby="basic-addon2" name="diachi"></td>
      </tr>
        <td>
            <input type="submit" name="luu" value="Lưu" class="buttontable">
