...
<div id="content-wrapper" class="d-flex flex-column">
    <div id="content">
        <div class="thanhhome">
            ...
            <i class="fas fa-greater-than"></i><a style="margin:0px 10px" href="themsanpham.html"><label>Thêm User</label></a>
        </div>

    <div class="taikhoanuser" style="margin: 10px 10px;">
        <form method="POST" action="sqlphp/usernew.php">
    ...
    <tbody>
      <tr>
        <td>Tên tài khoản: <input type="text" class="themuser form-control bg-light border-0 small" placeholder="Điền mã sản phẩm"aria-label="Search" aria-describedby="basic-addon2" name="taikhoanuser"></td>
      </tr>
      <tr>
        <td>Mật Khẩu: <input type="password" class="themuser form-control bg-light border-0 small " placeholder="Điền Tên Sản Phẩm"aria-label="Search" aria-describedby="basic-addon2" name="matkhauuser"></td>
      </tr>
      <tr>
        <td>Nhập lại mật khẩu:<input type="password" class="themuser form-control bg-light border-0 small " placeholder="Điền vào đây"aria-label="Search" aria-describedby="basic-addon2"></td>
      </tr>
      <tr>
        <td>
            <input type="submit" name="luu" value="Lưu" class="buttontable" name="luu">
            <input type="reset" name="thoat" value="Thoát" class="buttontable" name="thoat">
        </td>
      </tr>
