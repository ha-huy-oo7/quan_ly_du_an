...
{
    $sql_query="DELETE FROM admin WHERE id=".$_GET['delete_id'];
...
function edt_id(id)
{
    ...
    {
        window.location.href='suauser.php?edit_id='+id;
    }
}
...
<div class="container-fluid" style="font-size: 12px;">         
   ...
   <?php
    ...
    {   
        ...
        <td class="taikhoan"><?php echo $row[1] ?>
        </td>
        <td class="matkhau"><input class="pass" style="border:none" type="password" name="" value="<?php echo $row[2] ?>">   </td>
        <td>
